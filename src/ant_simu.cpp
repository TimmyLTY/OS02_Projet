...
int main(int nargs, char* argv[])
{
    ...
    if (!headless) {
        win_ptr = new Window("Ant Simulation", 2*land.dimensions()+10, land.dimensions()+266);
        renderer_ptr = new Renderer( land, phen, pos_nest, pos_food, ants );
    }
    ...
    std::cout << "=== Mesure des performances séquentielles ===" << std::endl;
    ...
    std::cout << "\n=============================================" << std::endl;
    std::cout << "  RAPPORT DE PERFORMANCE (version séquentielle)" << std::endl;
    std::cout << "=============================================" << std::endl;
